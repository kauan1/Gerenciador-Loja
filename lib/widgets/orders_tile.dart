      ...
      child: Card(
        child: ExpansionTile(
          key: Key(order.documentID),
            ...
            title: Text("${order.documentID.substring(order.documentID.length-7,
                 order.documentID.length)} - ${states[order.data["status"]]}",
            style: TextStyle(color: order.data["status"] != 4 ? Colors.grey[850]
                : Colors.green),
            ),
          children: <Widget>[
            Padding(
              ...
              child: Column(
                ...
                children: <Widget>[
                  OrderHeader(order),
                  Column(//coluna de todos os produtos comprados em uma venda
