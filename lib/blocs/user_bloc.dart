...
class UserBloc extends BlocBase{
  ...
  void _addUserListener(){//observar mudanças feitas em casa usuario
  ...
  void _subscribeToOrders(String uid){//pega as orders do firebase e guarda dentro do usuarios
  ...
  void _unsubscribeToOrders(String uid){//exclui as orders dos usuarios
