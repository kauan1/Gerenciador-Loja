...
import 'package:gerenciador_loja/blocs/product_bloc.dart';
import 'package:gerenciador_loja/validators/product_validators.dart';
...
class _ProductScreenState extends State<ProductScreen> with ProductValidators{
  ...
  _ProductScreenState(String categoryId, DocumentSnapshot product)://para definir um bloc no momento de contrução precisa usar o dois pontos
  ...
  Widget build(BuildContext context) {
    ...
    final _fieldStale = TextStyle(color: Colors.white, fontSize: 16);
